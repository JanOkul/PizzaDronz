...
public class FlightPath {
     ...
     *
     */
    public ArrayList<LngLat> GenerateFlightPath(Order order, Restaurant[] restaurants, NamedRegion[] no_fly_zones, NamedRegion central_region) {
        ...
        // This should not be possible to evaluate to true with order validation class but still here for redundancy.
